...
class CreateServiceCommandTest extends \PHPUnit_Framework_TestCase {
	...
	public function setUp() {
		...
		$command = Injector::create('Zenith\CLI\Command\CreateServiceCommand');
	...
	public function testEmptyParams() {
		$command = $this->application->find('service-create');
		$commandTester = new CommandTester($command);
		$success = $commandTester->execute(['command' => $command->getName(), 'class' => '']);
	...
	public function testRegexValidation() {
		$command = $this->application->find('service-create');
		$commandTester = new CommandTester($command);
		$success = $commandTester->execute(['command' => $command->getName(), 'class' => '123']);
	...
	public function testRegexValidation2() {
		$command = $this->application->find('service-create');
		$commandTester = new CommandTester($command);
		$success = $commandTester->execute(['command' => $command->getName(), 'class' => 'Ns/123']);
		$this->assertRegExp('/\'123\' is not a valid namespace\/class name/', $commandTester->getDisplay());
		$this->assertEquals(2, $success);
	}
	...
	public function testRegexValidation3() {
		$command = $this->application->find('service-create');
		$commandTester = new CommandTester($command);
		$success = $commandTester->execute(['command' => $command->getName(), 'class' => '123/Class']);
		$this->assertRegExp('/\'123\' is not a valid namespace\/class name/', $commandTester->getDisplay());
		$this->assertEquals(2, $success);
	}
	...
	public function testRegexValidation4() {
		$command = $this->application->find('service-create');
		$commandTester = new CommandTester($command);
		$success = $commandTester->execute(['command' => $command->getName(), 'class' => 'Ns/Class', 'methods' => ['123']]);
	...
	public function testRegexValidation5() {
		$command = $this->application->find('service-create');
		$commandTester = new CommandTester($command);
		$success = $commandTester->execute(['command' => $command->getName(), 'class' => 'Ns/Class', 'methods' => ['_hello', '321']]);
	...
	public function testExecute() {
		$command = $this->application->find('service-create');
		$commandTester = new CommandTester($command);
		$success = $commandTester->execute(['command' => $command->getName(), 'class' => $this->test_class]);
	...
	public function testExecute2() {
		$command = $this->application->find('service-create');
		$commandTester = new CommandTester($command);
		$success = $commandTester->execute(['command' => $command->getName(), 'class' => $this->test_route]);
		$this->assertRegExp('/New service created/', $commandTester->getDisplay());
